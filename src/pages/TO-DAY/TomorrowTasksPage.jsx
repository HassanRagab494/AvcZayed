  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // @ts-ignore
        const matchingData = allData.filter(item => item.date === tomorrow);
        ...
        setLoading(false); // توقف اللودر عند انتهاء التحميل
      }
    };
        ...
        <div className="Data">
          <div className="grob_btn">
            ...
            <div className="buttons-container">
              ...
              <button onClick={() => handleButtonClick("notCompleted")}>Not Completed</button>
              <button onClick={() => handleButtonClick("inProgress")}>In Progress</button>
              <button onClick={() => handleButtonClick(null)}>Show All</button>
            </div>
          </div>

          <div data-aos="zoom-in" className="inputs">
            {loading ? ( // عرض اللودر إذا كانت البيانات قيد التحميل
      ...
      >
        ...
        />
              ...
              filteredDisplayData.length > 0 ? (
                ...
                <p>No matching data for tomorrow's tasks.</p>
              )
            )}
          </div>
        </div>
...
export default TomorrowTasksPage;
