  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // تصفية البيانات بناءً على المهام التي تقع بين اليوم و 3 أشهر قادمة
        const upcomingTasks = fetchedData.filter((data) => {
          // @ts-ignore
          const taskDate = new Date(data.date);
          return taskDate >= currentDate && taskDate <= threeMonthsLater;
        });

        setAllData(upcomingTasks);
  ...
  return (
    <div>
      ...
      <div className='upcoming-tasks-page'>
        ...
        {/* عرض اللودر إذا كانت البيانات لا تزال قيد التحميل */}
        {isLoading ? (
